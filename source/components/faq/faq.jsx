...
class FAQ extends Component {
	...
	render() {
		...
		let faqs = [[
			{question: "Are there travel reimbursements?", answer: "We are planning to having busses going to various schools in lieu of travel reimbursements. A final list of schools will be released very soon!"},
